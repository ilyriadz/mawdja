...
public abstract class GameObject implements Combineable
{
    ...
    private Runnable onFadeFinished = null;
    private Circle fadeCircle = new Circle();
    private Duration fadeDuration = null;
    private boolean onFade = false;
    private boolean sensor = false;
    
    {
        fadeCircle.opacityProperty().addListener(((observable, oldValue, newValue) -> 
        {
            if (material() == null)
                return;
            ...
            if (color != null)
                material().setDiffuseColor(Color.rgb(
                    ...
                    (int)(color.getBlue() * 255), newValue.doubleValue()));
        }));
    }
    ...
    public void fadeIn()
    {
        ...
        FadeTransition ft = new FadeTransition(
            fadeDuration == null ? Duration.millis(2000) : fadeDuration, this.fadeCircle);
        ft.setCycleCount(1);
        ft.setFromValue(0);
        ft.setToValue(1);
        ft.setOnFinished(e ->
    ...
    public void setOnFadeFinished(Runnable onFadeFinished) {
