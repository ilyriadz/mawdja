...
public abstract class GameWorld
{
    ...
    public final void addAction(String name, Runnable run)
    {
    ...
    public final void addAction(String name, Runnable run, long millis)
    {
    ...
    public final Runnable getAction(String name)
    {
        if (!actionsMap.containsKey(name))
            throw new IllegalArgumentException("action '" + name + 
    ...
    public void setAfterGameWorldDestroyedAction(Runnable afterGameWorldDestroyed)
    {
    ...
    public final GameGroup getGameGroup(String gameGroupName)
    {
        if (!gamegroups.keySet().contains(gameGroupName))
            throw new IllegalStateException("GameZone '" + gameGroupName +
                    "' not exists in " + this);
    ...
    public final void destroy()
    {
        ...
        gamegroups.values().forEach(gameZone ->
        {
            gameZone.destroy();
            gameZone.clear();
        });
    ...
    {
        var gameZone = gamegroups.get(name);
        if (gameZone != null)
    ...
    public final void toStartPosition()
    {
    ...
    public final void changePlayerPosition(double x, double y)
    {
        var body = gameManager.player().body();
        body.setType(BodyType.STATIC);
        body.getPosition().set(
    ...
    public final void changePlayerPosition(BodyType type, double x, double y)
    {
        var body = gameManager.player().body();
        body.setType(BodyType.STATIC);
        body.getPosition().set(
